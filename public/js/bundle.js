...
},{}],"registration.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51L1FvoCtYJ2cb6mbCwWT75AXvUH7PZ7BCVcB5h45X5gsD0UyN3r786YpSCcJhXzQRyasKQaTPOfNNKFNwu8PxXnY0069pAYCzR'); // const stripe = require('stripe')(process.env.STRIPE_PUBLIC_KEY);

var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, clientReferenceId) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId, "?clientReferenceId=").concat(clientReferenceId));
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            backURL = data.get('backURL') ? data.get('backURL') : '/my-reviews';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
...
var updateReview = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/reviews/".concat(data.get('reviewId')),
              data: {
                "title": data.get('reviewTitle'),
                "content": data.get('reviewContent'),
                "rating": data.get('reviewRating'),
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Review successfully updated!');
              window.setTimeout(function () {
                location.assign(backURL);
              }, 1500);
            }
  ...
  return function updateReview(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success' || res.status === 204) {
              (0, _alerts.showAlert)('success', 'Review successfully deleted!');
              window.setTimeout(function () {
                location.assign(backURL);
              }, 1500);
            }
...
var myFavorites = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(favorites) {
    var alertMessage, params, href;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            alertMessage = 'You have no Favorite Tours for now!';
            (0, _alerts.showAlert)('success', alertMessage, 10);
            return _context.abrupt("return");

          case 4:
            try {
              params = favorites.join(',');
              href = "/my-favorites?favorites=".concat(params);
  ...
  return function myFavorites(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _registration.signup)(name, email, password, passwordConfirm);
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    (0, _registration.login)(email, password);
  });
}
...
if (bookBtn) {
  ...
  Array.from(bookBtn).forEach(function (element) {
    element.addEventListener('click', function (e) {
      e.target.textContent = 'Processing...';
      var _e$target$dataset = e.target.dataset,
          tourId = _e$target$dataset.tourId,
          clientReferenceId = _e$target$dataset.clientReferenceId;
      (0, _stripe.bookTour)(tourId, clientReferenceId);
    });
  });
...
if (favoriteList) {
  ...
  var favorites = JSON.parse(localStorage.getItem('favorites')) || []; // set correct icon for favorited item

  favorites.forEach(function (favorite) {
    if (document.getElementById(favorite)) {
      var firstChild = document.getElementById(favorite).firstChild;
      firstChild.setAttribute("xlink:href", "img/icons.svg#icon-fixed-star-fill");
    }
  });
  Array.from(favoriteList).forEach(function (element) {
    element.addEventListener('click', function (e) {
      var id = e.target.id,
          item = e.target,
      ...
      if (index == -1) {
        ...
        favorites.push(id); // Item is already favorite
      } else {
